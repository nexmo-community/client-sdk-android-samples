...
public class MarkMessageAsDeliveredActivityJava extends AppCompatActivity {
    ...
    private NexmoMessageEventListener messageListener = new NexmoMessageEventListener() {
        ...
        public void onTextEvent(@NonNull NexmoTextEvent textEvent) {
            textEvent.markAsDelivered(markAsDeliveredListener);
        }
    ...
    private NexmoRequestListener markAsDeliveredListener = new NexmoRequestListener() {
        @Override
